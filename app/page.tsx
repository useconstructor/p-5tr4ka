...
export default function Home() {
  ...
  <a href="https://wa.me/5215500000000" target="_blank" rel="noopener noreferrer" style={{position:'fixed',bottom:'1.5rem',right:'1.5rem',zIndex:9999,background:'#25D366',color:'#fff',borderRadius:'9999px',padding:'0.75rem 1.25rem',textDecoration:'none',fontWeight:700,display:'flex',alignItems:'center',gap:'0.5rem',boxShadow:'0 4px 12px rgba(0,0,0,0.3)',fontSize:'0.9rem'}}>💬 Escríbenos</a>
    </main>
}
